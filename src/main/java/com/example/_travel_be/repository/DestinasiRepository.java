...
public interface DestinasiRepository extends JpaRepository<Destinasi, UUID> {
    
    // Metode Kustom yang dibuat berdasarkan kebutuhan Class Diagram (misalnya filter berdasarkan lokasi)
